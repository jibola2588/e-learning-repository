export const ContactForm = () => {
    return(
        <div className="pl-6 split-res-bg py-8 lg:pl-[76px] pr-3 lg:py-[91px] mt-10 lg:mt-0 w-full">
            <div className="bg-white w-full rounded-[11.8889px] md:rounded-[20px]">
                <form className="px-6 md:px-20 pb-10 pt-6 lg:px-[51px] lg:pb-8 lg:pt-7" action="">
                    <div className="block">
