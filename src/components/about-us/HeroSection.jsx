        ...
        <div className='bg-[#EBF1FF] overflow-hidden'>
            <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 relative pb-44">
                <div className="flex flex-col md:flex-row items-center sm:items-start text-center sm:text-start">
                    ...
                    <div className="heroShapes flex-1 mt-6 sm:mt-0">
                        <div className="shape1 mr-8 w-44 sm:w-[296.77px] h-44 sm:h-[296.77px] bg-[#FBE3B2] rounded-full"></div>
                        <div className="shape1 ml-12 w-44 sm:w-[296.77px] h-44 sm:h-[296.77px] bg-[#D2F8FF] rounded-full absolute left-[150px] sm:left-[850px] top-[300px] sm:top-[135px]"></div>
                    </div>
                </div>
            </div>
        </div>
